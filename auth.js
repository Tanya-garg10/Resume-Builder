// auth.js - Handles authentication, registration, login, logout, and redirect
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const loginCloseBtn = document.querySelector('.login-close-auth');
  ...
  /* =======================
       FORM TOGGLE LOGIC (Modal)
  ======================== */
  if (showLogin) showLogin.addEventListener('click', (e) => { e.preventDefault(); toggleAuthForms('login'); });
  if (showRegister) showRegister.addEventListener('click', (e) => { e.preventDefault(); toggleAuthForms('register'); });
  if (topLoginBtn) topLoginBtn.addEventListener('click', (e) => { e.preventDefault(); toggleAuthForms('login'); });
  if (topRegisterBtn) topRegisterBtn.addEventListener('click', (e) => { e.preventDefault(); toggleAuthForms('register'); });
  ...
  if (loginForm) {
    loginForm.addEventListener('submit', function (e) {
      ...
      window.location.href = "resume-builder.html"; // redirect to resume builder
    });
  }
  ...
  /* =======================
       CLOSE MODALS
  ======================== */
  if (regCloseBtn) regCloseBtn.addEventListener('click', () => { authSection?.classList.add('hidden'); registerForm?.reset(); });
  if (loginCloseBtn) loginCloseBtn.addEventListener('click', () => { authSection?.classList.add('hidden'); loginForm?.reset(); });
